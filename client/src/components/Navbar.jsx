  ...
  return (
    <div className='flex items-center justify-between px-4 py-3 lg:mx-44'>
...

      {
        ...
        : <button onClick={()=>openSignIn({})} className='bg-zinc-800 text-white flex items-center gap-4 px-4 py-2 rounded-full hover:bg-zinc-700 transition-colors duration-300'>
